...
const config = {
  ...
  //api_base_url: 'http://114.116.199.8:18180/4000/4000/0/',
  ...
  uncheck_login_request: ['person.cart.getCart', 'getFreepostageAndActivityInfo', 'person.order.getTrafficnoList'],
