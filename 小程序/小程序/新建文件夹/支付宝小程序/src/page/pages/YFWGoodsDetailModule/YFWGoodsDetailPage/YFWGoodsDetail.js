...
export default class YFWGoodsDetail extends Component {
  ...
  dealParams(params) {
    if (params.type === "sellers") {
      ...
      this.setState({
        ...
        'medicine_info.price': toDecimal(medicine.pric),
        ...
        'medicine_info.medicine_name':safe(medicine.aliascn) + " " + safe(medicine.namecn),
        ...
        'medicine_info.medicine_bentrusted_name': safe(medicine.bentrusted_store_name),
  ...
  render() {
    ...
    return (
      <scrollView onScroll={this.mainScroll} scrollTop={scrollTop} scrollY style={"width:100vw;height:" + wrapperHeight + "px;padding-bottom:" + 0} classNmae="back-white">
  ...
  renderService() {
    ...
    return (
      <View className="detail-services flex-row flex-wrap" style={"width:100%"}>
        {medicine_services.map((service,index) => {
          const _style=index == 0 ? "margin-left:10px":"margin-left:0px"
          return (
            <View
  ...
  renderallowed() {
    ...
    if (medicine_info.medicine_type <= 0) {
      return (
        <View style={"width:55vw;display:flex;height:100%"}>
          <View
  ...
  renderallowChild() {
    return (
      <View
        ...
        style={"background-color:#999;width:55vw"}
      >
  ...
  onSingleAndPackageClick() {
    const {medicine_status,verFlag,medicine_info,wx_rx_is_buy} = this.state;
    if(medicine_status == 1){
      if((verFlag == 1 && medicine_info.medicine_type<=0) || (verFlag == 2 && (wx_rx_is_buy || medicine_info.medicine_type<0)) ){
