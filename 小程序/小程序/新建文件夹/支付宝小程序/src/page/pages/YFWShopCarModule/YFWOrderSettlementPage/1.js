...
export default class YFWOrderSettlement extends Component {
  ...
  componentWillUnmount () { 
    var info = getGlobalData('inquiryInfo');
    info.isSave = false;
  ...
  handleNeedenrollment(){
    pushNavigation('get_nrollment',{'hasPatient':this.state.orderInfo.medicate_info_type})
  }
  /** 关闭弹窗 */
  ...
  render () {
    const { orderInfo,isCompleteInquiry,invoiceModalShow,opacityAnimation,translateAnimation,invoice,isCompleteYqfk,is_needenrollment } = this.state
    const shopItems = orderInfo.shop_items || [];
    const unsign = !isCompleteYqfk?'../../../../images/unsign.png':'../../../../images/hassignin.png'
    return (
      <View className='settlement'>
        ...
        {is_needenrollment && (
          ...
          <Image className="unsign" src={require(unsign)}></Image>
          ...
          >
            ...
            {invoice.isNeed ? (
              <ScrollView
                ...
                onTouchMove={this.handleInvoiceMove}
              >
                ...
                <View className="invoice-info">
                  ...
                  <Input
                    ...
                    onInput={this.handleInvoiceCodeInput}
                    maxlength="18"
  ...
  renderStoreMoneyView (storeItem) {
    ...
    const { modalList ,shop_id,invoiceMap} = storeItem
    return(
      <Block>
  ...
  renderNormalItem (modalItem) {
    //const {} = modalItem.selectInfo;
    return(
      <View className='settlement-normal-item settlement-row settlement-algin-center' onClick={this.onNormalItemClick.bind(this, modalItem)}>
        <Text className='settlement-normal-item-title settlement-dark-text settlement-12-text'>{modalItem.title}</Text>
        {/* <Text className='settlement-normal-item-title settlement-dark-text settlement-12-text'>{modalItem.}</Text> */}
        <Text className={'settlement-normal-item-content settlement-12-text settlement-light-text'}>{modalItem.content}</Text>
        <View className='settlement-normal-item-arrow settlement-row settlement-content-end settlement-algin-center'>
