...
export default class YFWInvoiceModal extends Component {
  ...
  render () {
    ...
    const layoutTranslate = _isOpened ? (_isEdit ? 'transform: translate(0, 0);' : 'transform: translate(0, 0);') : 'transform: translate(0, 100%);'
          ...
          <View className='invoice-layout-content'>
            ...
            {_invoice.type === 1 && <View className='invoice-column invoice-margin-left-3vw invoice-margin-top-10'>
              ...
              <Input 
                ...
                maxLength={10}
                value={_invoice.name}
                onFocus={this.onInoviceFocus.bind(this)}
